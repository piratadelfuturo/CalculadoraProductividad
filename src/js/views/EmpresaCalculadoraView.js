define([
    'backbone',
    'underscore',
    "../models/EmpresaCalculadora",
    'jquery',
    'gagauge',
    "../data/mexico_paths",
    "../data/mexico_empresa_estados",
    "../data/mexico_empresa_sectores",
    "../data/mexico_efemerides_empresa",
    'raphael',
    'accounting',
    'graphael',
    'bootstrap'
        ...
        function(
                ...
                Gagauge,
                mexico_paths,
                mexico_empresa_estados,
                mexico_empresa_sectores,
                efemerides,
                Raphael,
                accounting) {
